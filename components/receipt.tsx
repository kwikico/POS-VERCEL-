...
export default function Receipt({ receipt, onStartNewTransaction }: ReceiptProps) {
  ...
  // Render the current receipt tab
  const renderCurrentReceipt = () => (
    <>
        ...
        {!selectedTransaction ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button onClick={handleSaveTransaction} disabled={isSaving} className="bg-blue-600 hover:bg-blue-700">
                {isSaving ? (
                  <>
